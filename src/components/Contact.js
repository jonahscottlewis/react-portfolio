      ...
      <MDBContainer fluid className="vh-100 bkgrd">
          <div className="d-flex w-100 justify-content-center" >
              ...
              <form className="w-25 mt-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                className="w-100"/>
                {errors.senderName && <p className="mw-100">Enter your name</p>}
                ...
                className="w-100"/>
                {errors.email && <p className="mw-100">Valid email is required</p>}
                ...
                className="w-100"/>
                {errors.message && <p className="mw-100">Enter your message</p>}
